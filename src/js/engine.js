...
const ResizeHandler = {
  ...
  // On the original this file is a classic <script>, so it always registers
  // before load fires. Imported as an ES module it can evaluate *after* load,
  // which would strand the page on the preloader's from-state (blank).
